...
@Composable
fun DownloadForm(onDismissRequest: () -> Unit) {
    Form(onDismissRequest) {
        val uiState = rememberSaveable { UiState() }
        val windowSizeClass = LocalWindowSizeClass.current

        // On Android, the extra options are shown as another sheet
        // On desktop they are shown inline with the form
