...
open class SearchResult private constructor(open val id: String? = null, open val etag: String) {
    internal companion object {
        internal fun fromYt(searchResult: YtSearchResult): SearchResult = when (searchResult.id.kind) {
    ...
    data class Channel internal constructor(
        ...
        internal constructor(searchResult: YtSearchResult) : this(
            ...
            liveBroadcastContent = LiveBroadcast.valueOf2(
                searchResult.snippet.liveBroadcastContent
            )
        )
    }

    data class Playlist internal constructor(override val id: String, override val etag: String) : SearchResult(id, etag) {
        internal constructor(searchResult: YtSearchResult) : this(
