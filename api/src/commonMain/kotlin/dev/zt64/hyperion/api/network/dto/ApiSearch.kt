...
import dev.zt64.hyperion.api.network.dto.renderer.ItemSectionRendererSerializer
...
internal class ItemsSerializer : JsonTransformingSerializer<List<Item>>(ListSerializer(Item.Serializer)) {
