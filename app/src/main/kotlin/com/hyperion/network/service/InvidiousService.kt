...
object InvidiousService {
    // TODO: Add instance selector setting
    ...
    suspend fun getTrending(region: String = Locale.current.region): List<TrendingVideo> =
    ...
    suspend fun getComments(videoId: String, continuation: String? = null): VideoComments =
